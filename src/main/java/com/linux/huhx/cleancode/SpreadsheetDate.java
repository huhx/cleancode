 ...
 * <P>
 * Be aware that there is a deliberate bug in Excel that recognises the year 1900 as a leap year when in fact it is not a leap year. You can find more information on the Microsoft
 * website in article Q181370:
 * <P>
 * http://support.microsoft.com/support/kb/articles/Q181/3/70.asp
 * <P>
 * Excel uses the convention that 1-Jan-1900 = 1.  This class uses the convention 1-Jan-1900 = 2. The result is that the day number in this class will be different to the Excel
 * figure for January and February 1900...but then Excel adds in an extra day (29-Feb-1900 which does not actually exist!) and from that point forward the day numbers will match.
 *
...
public class SpreadsheetDate extends SerialDate {
   ...
   * <P>
   * This method will return true ONLY if the object is an instance of the {@link SerialDate} base class, and it represents the same day as this {@link SpreadsheetDate}.
   *
  ...
  /**
   * Returns <code>true</code> if this {@link SerialDate} is within the specified range (INCLUSIVE).  The date order of d1 and d2 is not important.
   *
